function startApp() {
  ...
  async function getAllAds() {
    ...
    try {
      ...
      let buttonEdit = $(container).find('.ad-box').find('.edit');
      let buttonDelete = $(container).find('.ad-box').find('.delete');

      buttonEdit.click(getEditInfo);
      buttonDelete.click(deleteAd);
    } catch (error) {
      displayError(error);
    }
  }
